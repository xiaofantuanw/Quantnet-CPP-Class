...
public:
	...
	std::vector<double> DeltaCallS(double h, int N) const;
	std::vector<double> DeltaPutS(double h, int N) const;
	std::vector<std::vector<double>> SensitiveMat(int index_change, double h, int N) const;
...
//std::vector<double> CallPricingS(double begin, double end, double h, double T, double K, double sig, double r,double b);
//std::vector<double> PutPricingS(double begin, double end, double h, double T, double K, double sig, double r);
//std::vector<std::vector<double>> PricingMat(double T,double K, double sig,double r,double S,int index_change,double end,double h);
