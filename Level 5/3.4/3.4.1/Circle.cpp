...
Circle::Circle():centerpoint(0,0),m_radius(1)//Default constructor using colon syntax
{
	//centerpoint = Point(0, 0);//Default centerpoint
	//m_radius = 1;//Default radius
}

Circle::Circle(const Circle& source):centerpoint(source.centerpoint), m_radius(source.m_radius)
...
Circle::Circle(const Point& centerpt, const double rad):centerpoint(centerpt),m_radius(rad)
