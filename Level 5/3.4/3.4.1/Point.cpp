...
Point::Point():m_x(0),m_y(0)//Default constructor using colon syntax
{
	//m_x = m_y = 0;
	std::cout << "Default Constructor" << std::endl;
}

Point::Point(const Point& source):m_x(source.m_x),m_y(source.m_y)//Copy constructor using colon syntax
{
	//m_x = source.m_x;
	//m_y = source.m_y;
...
Point::Point(const double initxvalue, const double inityvalue):m_x(initxvalue),m_y(inityvalue)
//Constructor with initialization,using colon syntax
{
	//m_x = initxvalue;
	//m_y = inityvalue;
